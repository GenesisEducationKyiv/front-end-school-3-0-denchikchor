import { a as requireReact, g as getDefaultExportFromCjs, r as reactExports } from './index-DrwnGJ8a.js';
...
function requireWithSelector () {
	...
	"use strict";
	if (true) {
	  withSelector$2.exports = requireUseSyncExternalStoreWithSelector_production();
	} else {
        ...
        if (propsContext?.Consumer) {
          if (false) {
            const isValid = /* @__PURE__ */ isContextConsumer(
              // @ts-ignore
              /* @__PURE__ */ reactExports.createElement(propsContext.Consumer, null)
            );
            if (!isValid) {
              throw new Error(
...
//# sourceMappingURL=react-redux-Dbn8ieHe.js.map
