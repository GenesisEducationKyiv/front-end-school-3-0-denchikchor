const __vite__mapDeps=(i,m=__vite__mapDeps,d=(m.f||(m.f=["assets/TrackList-25tADTRk.js","assets/react-redux-Dbn8ieHe.js","assets/index-DNNkfZj1.js","assets/TrackList-WITbe243.css"])))=>i.map(i=>d[i]);
...
function __pwRender(value) {
  return window.__pwTransformObject(value, v => {
    if (isJsxComponent(v)) {
      ...
      return { result: ct.createElement(type, ...createElementArguments) };
    }
  });
}
...
window.playwrightMount = async (component, rootElement, hooksConfig) => {
  ...
  const App = () => {
    /** @type {any} */
    const [renderer, setRenderer] = ct.useState(() => __pwRender(component));
  ...
  root.render(ct.createElement(AppWrapper));
...
const _Users_denissokolov_Documents_GitHub_front_end_school_3_0_denchikchor_tests_react_redux_Provider = () => __vitePreload(() => import('./react-redux-Dbn8ieHe.js'),true              ?[]:void 0).then((mod) => mod.Provider);
const _Users_denissokolov_Documents_GitHub_front_end_school_3_0_denchikchor_tests_react_router_dom_MemoryRouter = () => __vitePreload(() => import('./index-DNNkfZj1.js'),true              ?[]:void 0).then((mod) => mod.MemoryRouter);
const _Users_denissokolov_Documents_GitHub_front_end_school_3_0_denchikchor_src_components_TrackList_TrackList = () => __vitePreload(() => import('./TrackList-25tADTRk.js'),true              ?__vite__mapDeps([0,1,2,3]):void 0).then((mod) => mod.default);
__pwRegistry.initialize({ _Users_denissokolov_Documents_GitHub_front_end_school_3_0_denchikchor_tests_react_redux_Provider,
  _Users_denissokolov_Documents_GitHub_front_end_school_3_0_denchikchor_tests_react_router_dom_MemoryRouter,
  _Users_denissokolov_Documents_GitHub_front_end_school_3_0_denchikchor_src_components_TrackList_TrackList });

export { requireReact as a, requireReactDom as b, ct as c, getDefaultExportFromCjs as g, reactExports as r };
//# sourceMappingURL=index-DrwnGJ8a.js.map
